...
# the Best Critical Region for testing a simple hypothesis (𝐻0) against a composite hypothesis (𝐻1), using a Likelihood Ratio Test (LRT). 
# Parameters
mu0 <- 5 # Null hypothesis mean
mu1 <- 6 # Alternative hypothesis mean =>The population mean is greater than 5.
...
# Critical region =>Critical Value is the threshold for rejecting 𝐻0
